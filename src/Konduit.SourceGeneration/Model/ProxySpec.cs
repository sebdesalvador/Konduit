...
/// <param name="ImplementationForTypeOf">
/// The implementation this proxy is specialised for, or <see langword="null"/> when it serves any
...
internal sealed record ProxySpec(
    ...
    string? ImplementationForTypeOf,
